...
parallelism=8;
integer_part=5;
file1 = fopen('fileOutputsMATLAB_conv1.txt','r');
file2 = fopen('fileOutputsVHDL_conv1.txt','r');
...
title('Output of Modelsim vs output of MATLAB absolute error - CONV1\_MAX1');
ylim([-100 100]);
